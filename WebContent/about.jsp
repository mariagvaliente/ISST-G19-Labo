                        ...
                        <div class="col-md-8 col-sm-6 col-xs-2">
                            <div class="main-menu">
                                <ul class="visible-lg visible-md">
                                    ...
                                    <li><a href="estimacion.jsp">Services</a></li>
                                    <li><a href="events.jsp">Events</a></li>
                                	<li class="active"><a href="about.jsp">About Us</a></li>
                                    <li><a href="historia.jsp">Contact</a></li>
                                </ul>
                ...
                <div class="row"><!-- first row -->
                	...
                	<div class="col-md-6"><!-- first column -->
                        <div class="widget-item">
                            ...
                            <p>You may visit <a href="http://tourkrub.co" target="_parent">Tour Krub</a> website for Thai Tour Packages. Thank you. Sed lacinia nulla sit amet ligula porta, vitae mattis nunc posuere. Curabitur eu aliquam erat. Etiam sollicitudin est eu turpis dapibus aliquet. Ut vitae lacus vel nulla iaculis interdum.<br><br>
