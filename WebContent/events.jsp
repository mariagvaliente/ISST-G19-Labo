                ...
                <div class="row"><!-- first row -->
                    ...
                    <div class="col-md-4"><!-- second column -->
                        <div class="widget-item">
                            ...
                            <p>You may visit <a href="http://tourkrub.co" target="_parent">Tour Krub</a> website for Thai Tour Packages. Thank you. Interdum et fames ac ante ipsum primis in faucibus. Aliquam justo lectus, fermentum vitae libero, tincidunt accumsan magns. <br><br>Vestibulum congue lorem odio, at sodales nisi luctus quis. Suspendisse suscipit ligula libero, id consectetur magna dictum sed.</p>
                        </div> <!-- /.widget-item -->
                    </div> <!-- /.col-md-4 -->
