...
<html lang="en">
<head>
<title>Estimación o Laboratorio</title>
<meta charset="utf-8">
				...
				<div class="owl-carousel owl-theme home_slider">
					...
					<div class="slide">
						<div class="background_image"
							style="background-image: url(https://images.ecosia.org/fZAIvyixyA3tDnNv0tBwugD8yfs=/0x390/smart/http%3A%2F%2Fmartingranados.es%2Fwp-content%2Fuploads%2F2016%2F11%2FHemiciclo-congreso-de-los-diputados.jpg)"></div>
									...
									<div class="col">
										<div class="home_content text-center">
											...
											<div class="booking_form_container">
												<form action="ConsultaEncuestaServlet" class="booking_form">
													<div
													...
													<div>
														<button class="booking_button trans_200">Compruébalo</button>
													</div>
												</form>
											</div>
										</div>
					...
					<div class="slide">
						<div class="background_image"
							style="background-image: url(https://extraconfidencial.com/wp-content/uploads/2017/07/congreso-vacaciones.jpg)"></div>
						<div class="home_container">
							<div class="container">
								<div class="row">
									<div class="col">
										...
										<div class="home_content text-center">
											...
											<div class="booking_form_container">
												<form action="PactometroServlet" class="booking_form">
													...
													<div>
														<button class="booking_button trans_200">Pactómetro</button>
													</div>
												</form>
											</div>
										</div>
